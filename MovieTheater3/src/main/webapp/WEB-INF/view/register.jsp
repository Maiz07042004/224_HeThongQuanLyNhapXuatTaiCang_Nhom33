...
<body>
		...
		<form:form action="${pageContext.request.contextPath}/register"
			...
			<div class="accountType">
				<input type="radio" value="2" id="2" name="roleID" checked /> <label
					for="2" class="radio">Buyer</label> <input type="radio" value="3"
					id="3" name="roleID" /> <label for="3" class="radio"
					style="margin-left: 31px;">Seller</label>
			</div>
			<div class="getOtp" align="center">
				<input type="text" name="one_time_password" id="one_time_password"
					placeholder="OTP" required />
				<button type="button" id="btnn" onclick="getOtp()" class=btnotp>Get
					OTP</button>
			</div>
	...
	<script type="text/javascript">
		function getOtp() {
			...
			var url = "http://localhost:8012/OnlineShopping/Ticket_Selling/getOtp/"
					+ email;
