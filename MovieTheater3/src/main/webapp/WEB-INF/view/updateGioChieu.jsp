...
<div class="col-md-8" id="content">
	...
	<div class="box-wrapper container-fluid">
		<div>
			<p class="text-show-time">CẬP NHẬT GIỜ CHIẾU</p>
		</div>
		<c:set var="contextPath" value="${pageContext.request.contextPath}" />
		<div style="margin-top: 10px;">
		<form:form
			action="${contextPath}/Ticket_Selling/thucHienUpdateGioChieu"
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<form:input path="scheduleTime" name="scheduleTime"
						id="scheduleTime" type="time" class="form-control"></form:input>
				</div>
			</div>
