...
<body style="background-color: #eff0f3">
	<div id="content" style="float: right; width: 1050px;">
		<div class="box-movie-center shadow p-3 mb-5 bg-white rounded">
			<div class="d-flex justify-content-center">
				<label
					style="font-size: 22px; color: red; font-family: arial; text-align: center; width: 100%;">Đơn hàng của bạn đang được chuẩn bị và sẽ được gửi đến bạn trong thời gian sớm nhất!</label>
			</div>
			<br>
			<div class="d-flex justify-content-center">
