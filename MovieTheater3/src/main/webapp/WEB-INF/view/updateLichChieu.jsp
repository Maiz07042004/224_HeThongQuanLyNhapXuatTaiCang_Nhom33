...
<div class="col-md-8" id="content">
	...
	<div class="box-wrapper container-fluid">
		<div>
			<p class="text-show-time">CẬP NHẬT LỊCH CHIẾU</p>
		</div>
		<c:set var="contextPath" value="${pageContext.request.contextPath}" />
		<form:form
			action="${contextPath}/Ticket_Selling/thucHienUpdateLichChieu"
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<form:input path="scheduleSeatID" name="scheduleSeatID"
						id="scheduleSeatID" type="text" class="form-control" readonly=""></form:input>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				<label class="col-sm-4 col-form-label">Mã ghế ngồi:</label>
				<div class="col-sm-8">
			...
			<div class="form-group row">
				<label class="col-sm-4 col-form-label">Mã vé:</label>
				<div class="col-sm-8">
