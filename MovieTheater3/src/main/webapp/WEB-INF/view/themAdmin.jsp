...
<body>
	<div class="testbox">
		...
		<form:form action="${pageContext.request.contextPath}/themAdmin"
			method="POST" modelAttribute="formAddAdmin">
			<hr>
			...
			<div class="regist">
				<button type="submit" id="btnn" class=btn>Add Admin</button>
			</div>
		</form:form>
