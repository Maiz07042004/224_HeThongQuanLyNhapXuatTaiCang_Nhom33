			...
			<nav class="nav-sidebar" style = "border-right: 0;border-right: 1px solid #ddd;">
				<ul class="nav row">			
					...
					<c:if test="${account.getRoles().roleID eq 1}">		
						<li  class="col-sm-12" style = "margin-top: 20px"><a href="<c:url value ='/Ticket_Selling/duyetSeller'/>"><i class="fa fa-film" aria-hidden="true"></i>&ensp;Duyệt Seller đăng ký mới</a></li>					
						<li  class="col-sm-12" style = "margin-top: 20px"><a href="<c:url value ='/Ticket_Selling/themAdmin'/>"><i class="fa fa-desktop" aria-hidden="true"></i>&ensp;Thêm mới Admin</a></li>
											<li  class="col-sm-12"style = "margin-top: 20px"><a href="<c:url value ='/Ticket_Selling/listDanhMuc'/>"><i class="fa fa-clock-o" aria-hidden="true"></i>&ensp;Quản lý danh sách danh mục</a></li>
					<li  class="col-sm-12"style = "margin-top: 20px"><a href="<c:url value ='/Ticket_Selling/themMoiSanPham'/>"><i class="fa fa-clock-o" aria-hidden="true"></i>&ensp;Thêm mới sản phẩm</a></li>
...
<%-- 					<li  class="col-sm-12" style = "margin-top: 20px"><a href="<c:url value ='/Ticket_Selling/listGheNgoi'/>"><i class="fa fa-ticket" aria-hidden="true"></i>&ensp;Quản lý danh sách ghế ngồi</a></li>
					...
					<li  class="col-sm-12"style = "margin-top: 20px"><a href="<c:url value ='/Ticket_Selling/updateProfile'/>"><i class="fa fa-clock-o" aria-hidden="true"></i>&ensp;Sửa hồ sơ</a></li>
