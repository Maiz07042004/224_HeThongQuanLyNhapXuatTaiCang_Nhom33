...
<title>MTS Online Shopping</title>
<script
...
<body>
	<div class="col-md-12"
		style="background-color: #595ED7; margin-bottom: 30px">
			...
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a style="color: white; font-size: 30px" class="navbar-brand fpt"
						...
						class="fa fa-home" aria-hidden="true"></i>&ensp;MTS Online Shopping</a>
				</div>
				<!-- Search form -->
				...
				<div align="center">
					<form class="form-inline" style="width: 600px"
						...
						<input class="form-control form-control-sm mr-3 w-75" type="text"
							placeholder="Tìm kiếm ..." aria-label="Search" name="movie" />
						<button style="background-color: #595ED7; border: none;"
					...
					<c:if test="${account ne null}">
						<li><a style="color: white"
							href="${pageContext.request.contextPath}/logout"><i
								...
								<li><a style="color: white"
							href="${pageContext.request.contextPath}/toCart"><i
								class="fa fa-shopping-cart" aria-hidden="true" style="color: white;"></i>
								Giỏ hàng</a></li>
					</c:if>
