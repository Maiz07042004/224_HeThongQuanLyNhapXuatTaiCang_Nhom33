...
import doan.onlineshopping.repository.IAccountRepository;
import doan.onlineshopping.service.IAccountService;
@Service
public class AccountServiceImpl implements IAccountService {
	...
	public List<Account> getListSellerByMonth(){
		return accountRepository.getListSeller();
	}
	
	public List<Invoice> getListBuyerByMonth(String id){
		return accountRepository.getListBuyer(id);
	}
	
	public List<Account> getListSeller(){
		return accountRepository.getListApprovingSeller();
	}
	...
	public void updateListSeller(String username){
		accountRepository.updateListApprovingSeller(username);
	}
