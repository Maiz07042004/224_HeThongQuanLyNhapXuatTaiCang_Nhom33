 ...
 *	@version 1.0
 */
package doan.onlineshopping.config;
...
@EnableJpaRepositories(basePackages = "doan.onlineshopping.repository")
public class SpringConfig {
	...
	DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:sqlserver://DESKTOP-6754H25:1433; databaseName=OnlineShopping;user=sa;password=123123;" + "encrypt=true;trustServerCertificate=true");
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
		...
		entityManager.setPackagesToScan("doan.onlineshopping.entity");
