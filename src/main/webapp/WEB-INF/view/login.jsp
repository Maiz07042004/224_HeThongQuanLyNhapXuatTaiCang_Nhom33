			...
			<div class="wthree-form">
				...
				<div class="form-sub-w3">
					...
					<div class="icon-w3">
						...
						<a style="color: #595ed7" href="/CangTienSa/forgotpassword"><u>Forgot Password.</u></a>
					</div>
				</div>
				...
				<div class="submit-agileits">
					<a style="color: #595ed7" href="/CangTienSa/register"><u>Don't have an account? Register here.</u></a>
				</div>
